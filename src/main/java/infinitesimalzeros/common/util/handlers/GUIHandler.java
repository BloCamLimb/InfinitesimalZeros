...
public class GUIHandler implements IGuiHandler {
	...
	{
		if(ID == 0) return new NanaFurnaceCon(player.inventory, (TileEntitySmelter)world.getTileEntity(new BlockPos(x,y,z)));
		return null;
	}
	...
	{
		if(ID == 0) return new NanaGUI(player.inventory, (TileEntitySmelter)world.getTileEntity(new BlockPos(x,y,z)));
		return null;
	}
