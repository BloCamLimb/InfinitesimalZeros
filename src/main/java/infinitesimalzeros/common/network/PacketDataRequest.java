	...
	public IMessage onMessage(DataRequestMessage message, MessageContext context) 
	{
		...
		PacketHandler.handlePacket(() ->
        {
            ...
            if(worldServer != null)
            {
				 ...
				 * 
				 * if(CapabilityUtils.hasCapability(tileEntity,
				 * Capabilities.GRID_TRANSMITTER_CAPABILITY, null)) { IGridTransmitter
				 * transmitter = CapabilityUtils.getCapability(tileEntity,
				 ...
				 * 
				 * if(CapabilityUtils.hasCapability(tileEntity,
				 * Capabilities.TILE_NETWORK_CAPABILITY, null)) { ITileNetwork network =
				 * CapabilityUtils.getCapability(tileEntity,
				 * Capabilities.TILE_NETWORK_CAPABILITY, null);
				 * 
				 * PacketHandler.network.sendTo(new TileEntityMessage(Coord4D.get(tileEntity),
