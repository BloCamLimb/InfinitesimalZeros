...
public class NanaFurnace extends BlockRegister implements ITileEntityProvider {
	
	public static final PropertyDirection FACING = PropertyDirection.create("facing");

	public static final PropertyBool RUNNING = PropertyBool.create("running");
	
	public NanaFurnace(String name) {
	...
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(RegistryBlocks.NanaFurnace);
	}*/
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		if(!worldIn.isRemote) {
			playerIn.openGui(InfinitesimalZeros.instance, 0, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
	...
	/*public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		if(active) worldIn.setBlockState(pos, RegistryBlocks.NanaFurnace.getDefaultState().withProperty(RUNNING, true), 3);
